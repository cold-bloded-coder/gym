...
<body>
  <?php if (isset($_GET['erro'])) {
    echo "<p style='display: none;' class='erro'>" . $_GET['erro'] . "</p>";
  } ?>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
          <li class="active"><a href="./i.php">Profile</a></li>
  ...
  <div class="jumbotron">
    <div class="row">
      ...
      <div class="col-md-8">&nbsp;
        ...
        <?php echo $row["days"]; ?><br>
        &nbsp;&nbsp;<label>Days Present</label>:
        <?php echo $row["present"]; ?><br>
        &nbsp;&nbsp;<label>Days Absent</label>:
        <?php echo $row["absent"]; ?><br>
        &nbsp;&nbsp;<label>Attendance Percentage</label>:
        <?php echo $row["pect"]; ?><br>
        <?php if ($row['paid'] == 1) { ?>
