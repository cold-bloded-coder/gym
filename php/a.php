...
<body>
  ...
  <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="./i.php">About Fitness</a>
      </div>
      <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
          <li><a href="./i.php">Profile</a></li>
          <li><a href="../workouts">Workouts</a></li>
          <li>
            <?php if (!isset($_SESSION['admin'])) {
              echo '<a href="./feed.php">Feedback</a>';
            } else {
          ...
          <li class="active"><a href="./a.php">Admin Panel</a></li>
        </ul>
  ...
  <div class="jumbotron" style="width: 100%;">
    <ul class="nav nav-tabs">
      ...
      <li><a href="#unp" data-toggle="tab">Unpaid Members&nbsp;<span class="badge">
            <?php echo mysqli_num_rows($um); ?>
          </span></a></li>
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane fade in active" id="register" style="background-color:#fff;">
        <form action="./register.php" method="POST" id="sign-up-form" class="form-signin">
          ...
          <div class="control-group">
            <input type="password" class="form-control" placeholder="password confirmation" name="confirmpwd"
              id="confirmpwd">
            <br />
          </div>
        ...
        <table class="table table-hover">
          ...
          <tbody>
            ...
            while ($row = mysqli_fetch_array($members)) {
              ...
              echo "<td>" . $row['pect'] . "</td>";
              echo "<td><a href='./edit.php?id=" . $row['id'] . "' class='btn btn-warning'>Edit</a>&nbsp;&nbsp;<a href='./delete.php?id=" . $row['id'] . "' class='btn btn-danger'>Delete</a></td>";
              echo "</tr>";
            }
            ?>
          </tbody>
